...
<?php $title='Naija Tastee Kitchen'?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                ...
                                                <img src="assets/img/food/spag.jpg" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                data-duration="2s" data-delay=".9s">
                                                <img src="assets/img/food/egusi-soup.jpg" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                data-duration="2s" data-delay=".9s">
                                                <img src="assets/img/food/White-rice.jpg" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="single-food-items">
                                    ...
                                    <div class="item-content">
                                        <a href="menu.php">
                                            <h3>Fried plantain per portion</h3>
                                        </a>
                                        <div class="text">Price</div>
                                        <h6>$3.50</h6>
                                    </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="offer-card style1  wow fadeInUp" data-wow-delay="0.7s"
                            style="background-image: url(assets/img/food/Fish.png);">
                            <div class="offer-content">
                                <h6>ON THIS WEEK</h6>
                                <h3>FRIED FISH</h3>
                                <p>limits Time Offer</p>
